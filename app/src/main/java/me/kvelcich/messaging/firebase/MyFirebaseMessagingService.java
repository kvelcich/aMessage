package me.kvelcich.messaging.firebase;
...
import me.kvelcich.messaging.Main;
...
public class MyFirebaseMessagingService extends FirebaseMessagingService {
    ...
    private void sendNotification(String messageBody, String sender) {
        ...
        Intent pkg = new Intent("receiveMsg");
        pkg.putExtra("message", new Message(sender, messageBody, false));
